...
source(here("R", "Factsheet", "Scripts", paste0("Fig_Arr_ATFM_Delay_country_airports_treemap.R")), encoding = "UTF8")
...
include_graphics(here("R", "Factsheet", "Figures", paste0("Annual_ATFM_Slot_", params$icao, ".png")))
...
include_graphics(here("R", "Factsheet", "Figures", paste0("Monthly_ATFM_Slot_", params$icao, ".png")))
