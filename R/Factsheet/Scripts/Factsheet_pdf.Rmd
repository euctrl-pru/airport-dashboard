...
Traffic_height2<<-100
source(here("R", "Factsheet", "Scripts", "Fig_Mvmts_country_airports.R"), encoding = "UTF8")
...
include_graphics(here("R", "Factsheet", "Figures", paste0("Hourly_throughput_", params$icao, ".png")))
