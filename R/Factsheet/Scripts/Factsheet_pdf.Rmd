...
header-includes: 
  ...
  - \posttitle{\end{center}}
    \includegraphics[width=2in,height=2in]{G:/HQ/dgof-pru/Project/Vertical_flight_efficiency/2015/airport-dashboard/R/Factsheet/Figures/ECTL_logo}\LARGE\\}
urlcolor: blue
subparagraph: yes
---
...
Traffic_height1<<-100
source(here("R", "Factsheet", "Scripts", "Fig_Total_mvmts_airport.R"), encoding = "UTF8")
source(here("R", "Factsheet", "Scripts", "Fig_Monthly_mvmts_airport.R"), encoding = "UTF8")
source(here("R", "Factsheet", "Scripts", "Fig_Market_segments_airport.R"), encoding = "UTF8")
...
Traffic_layout3<<-1
Traffic_height3<<-100
source(here("R", "Factsheet", "Scripts", "Fig_Avg_weekday_hourly_throughput.R"), encoding = "UTF8", local = TRUE)
