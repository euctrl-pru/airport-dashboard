...
```{r Tot-mvmts-yearly-test, echo=FALSE, fig.show='hold', fig.align='center', out.width="150px"}

include_graphics(c(here("R", "Factsheet", "Figures", paste0("Tot_mvmts_", params$icao, ".png")),
                   here("R", "Factsheet", "Figures", paste0("Monthly_mvmts_", params$icao, ".png")),
                   here("R", "Factsheet", "Figures", paste0("Monthly_mvmts_", params$icao, ".png"))))
