...
```{r Annual_Arr_ATFM_Delay-plotly}
...
```{r Annual_Arr_ATFM_Delay-ggplot, include=FALSE}

# Factsheet figure

atfm_pa_fig = ggplot(data=atfm_pa) +
  geom_bar(aes(x=YEAR, y=AVG_ARR_ATFM_REG, colour=REG_REASON), position = "dodge", stat="identity") +
  theme_bw() +
