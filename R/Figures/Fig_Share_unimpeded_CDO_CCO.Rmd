...
```{r Share-unimpeded-ggplot, include=FALSE}

# Factsheet figure

SHARE_CDO_CCO_FLIGHTS_PLOT_curr_year=filter(SHARE_CDO_CCO_FLIGHTS_PLOT, YEAR==Last_complete_year) %>% 
  ungroup() %>% 
  group_by(YEAR) %>% 
...
ggsave(here("R", "Factsheet", "Figures", paste0("SHARE_CDO_CCO_FLIGHTS_", Airport, ".png")), 
       plot=SHARE_CDO_CCO_FLIGHTS_PLOT_curr_year_fig, width = VFE_layout1[1]*Page_width, height = VFE_height1, 
