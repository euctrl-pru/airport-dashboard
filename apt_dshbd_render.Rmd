...
pun_col <- c( "#1f4e79", # EARLY >30		#rgb 31,78,121	
              ...
              "#c5e0b4", # EARLY 6-15	  #rgb 197,224,180	
              "#70ad47", # ON TIME -+5	#rgb 112,173,71	
              "#ffe699", # LATE 6-15		#rgb 255,230,153	
...
punc_dep_mm_plot$PUNCT_CAT <- factor(punc_dep_mm_plot$PUNCT_CAT,
                                     levels= c("Early >30","Early 16-30","Early 6-15","On Time -+5","Late 6-15","Late 16-30","Late 31-60","Late >60"))
