...
if (nrow(params$atfm) > 0) {
  ...
  share_atfm %>%
    ...
    add_download_button(share_atfm)
}
...
SLOT_MM_PLOT1 %>%
  ...
  add_download_button(SLOT_MM_PLOT1)
...
predepdly_py %>%
  ...
  add_download_button(predepdly_py)
...
predepdly_pm %>% 
  ...
  add_download_button(predepdly_pm)
