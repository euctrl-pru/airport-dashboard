...
```{r annual-traffic, child='R/Factsheet/Scripts/Fig_Annual_traffic.Rmd'}

```

### Monthly Traffic (Source: Network Manager)

```{r monthly-traffic, child='R/Factsheet/Scripts/Fig_Monthly_traffic.Rmd'}
...
```{r market-segment, child='R/Factsheet/Scripts/Fig_Market_segment.Rmd'}
...
```{r Avg-weekday-hourly-throughput, child='R/Factsheet/Scripts/Fig_Avg_weekday_hourly_throughput.Rmd'}
...
SHARE_CDO_CCO_FLIGHTS_PLOT <- params$cdo_cco %>% 
    select(YEAR, MONTH_NUM, SHARE_CDO_FLIGHTS, SHARE_CDO_FLIGHTS_BLW_70, SHARE_CCO_FLIGHTS, SHARE_CCO_FLIGHTS_BLW_100)
...
```{r Punctuality-DEP-YEARLY-LAYOUT, results='asis', eval=params$punc == "Y", echo = FALSE}
...
```{r Punctuality-DEP-MONHTLY-LAYOUT, results='asis', eval=params$punc == "Y", echo = FALSE}
...
```{r Punctuality-ARR-YEARLY-LAYOUT, results='asis', eval=params$punc == "Y", echo = FALSE}
...
```{r Punctuality-ARR-MONHTLY-LAYOUT, results='asis', eval=params$punc == "Y", echo = FALSE}
