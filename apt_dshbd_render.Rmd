...
```{r atfm-ytd, code=readLines('R/fig_share_atfm_delay.R')}
...
```{r ASMA-RWY-YEARLY-LAYOUT, results='asis', eval=params$apdf == "Y", echo = FALSE, code=readLines('R/fig_asma_rwy_yearly.R')}
...
```{r ASMA-RWY-MONTHLY-LAYOUT, results='asis', eval=params$apdf == "Y", echo = FALSE, code=readLines('R/fig_asma_rwy_monthly.R')}
...
```{r Taxi-out-time-title3, results='asis', eval=params$txotrwy_yy == "Y", echo = FALSE}
...
```{r TAXI-OUT-RWY-YEARLY-LAYOUT, results='asis', eval=params$txotrwy_yy  == "Y", echo = FALSE, code=readLines('R/fig_taxi_out_rwy_yearly.R')}

```


```{r Taxi-out-time-title4, results='asis', eval=params$txotrwy_mm == "Y", echo = FALSE}
...
```{r TAXI-OUT-RWY-MONHTLY-LAYOUT, results='asis', eval=params$txotrwy_mm == "Y", echo = FALSE, code=readLines('R/fig_taxi_out_rwy_monhtly.R')}
...
```{r TAXI-IN-RWY-YEARLY-LAYOUT, results='asis', eval=params$apdf == "Y", echo = FALSE, code=readLines('R/fig_taxi_in_rwy_yearly.R')}
...
```{r TAXI-IN-RWY-MONTHLY-LAYOUT, results='asis', eval=params$apdf == "Y", echo = FALSE, code=readLines('R/fig_taxi_in_rwy_monthly.R')}
