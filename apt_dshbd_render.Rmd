...
```{r annual-traffic, file='R/fig_annual_traffic.R'}

```

### Monthly Traffic (Source: Network Manager)

```{r monthly-traffic, file='R/fig_monthly_traffic.R'}
...
```{r market-segment, file='R/fig_market_segment.R'}
...
```{r Avg-weekday-hourly-throughput, file='R/fig_avg_weekday_hourly_throughput.R'}
...
```{r atfm-pa, file='R/fig_annual_arr_atfm_delay.R'}

```

### Monthly Arrival ATFM Delay (Source: Network Manager)

```{r atfm-pm, file='R/fig_monthly_arr_atfm_delay.R'}
...
```{r ANNUAL-ATFM-SLOT2, file='R/fig_annual_atfm_slot.R'}

```

### Monthly ATFM Slot Adherence (Source: Network Manager)

```{r MONTHLY-ATFM-SLOT2, file='R/fig_monthly_atfm_slot.R'}
...
```{r Avg-time-lvl, results='asis', eval=nrow(params$cdo_cco)>0, echo = FALSE, file='R/fig_avg_time_lvl.R'}
...
```{r Med-CDO-CCO-alt, results='asis', eval=nrow(params$cdo_cco)>0, echo = FALSE, file='R/fig_med_cdo_cco_alt.R'}
...
```{r Share-unimpeded, results='asis', eval=nrow(params$cdo_cco)>0, echo = FALSE, file='R/fig_share_unimpeded_cdo_cco.R'}
...
```{r ASMA-YEARLY-LAYOUT, results='asis', eval=params$apdf == "Y", echo = FALSE, file='R/fig_asma_yearly.R'}
...
```{r ASMA-MONTHLY-LAYOUT, results='asis', eval=params$apdf == "Y", echo = FALSE, file='R/fig_asma_monthly.R'}
...
```{r TXOT-YEARLY-LAYOUT, results='asis', eval=params$apdf == "Y", echo = FALSE, file='R/fig_taxi_out_yearly.R'}
...
```{r TAXI-OUT-MONTHLY-LAYOUT, results='asis', eval=params$apdf == "Y", echo = FALSE, file='R/fig_taxi_out_monthly.R'}
...
```{r TXIN-YEARLY-LAYOUT, results='asis', eval=params$apdf == "Y", echo = FALSE, file='R/fig_taxi_in_yearly.R'}
...
```{r TAXI-IN-MONTHLY-LAYOUT, results='asis', eval=params$apdf == "Y", echo = FALSE, file='R/fig_taxi_in_monthly.R'}
...
```{r pre-dep-dly-pa, results='asis', eval=params$apdf == "Y", echo = FALSE, file='R/fig_pre_departure_delay_yearly.R'}
...
```{r pre-dep-dly-month, results='asis', eval=params$apdf == "Y", echo = FALSE, file='R/fig_pre_departure_delay_monthly.R'}
...
```{r Punctuality-DEP-YEARLY-LAYOUT, results='asis', eval=params$punc == "Y", echo = FALSE, file='R/fig_punctuality_dep_yearly_layout.R'}
...
```{r Punctuality-DEP-MONHTLY-LAYOUT, results='asis', eval=params$punc == "Y", echo = FALSE, file='R/fig_punctuality_dep_monthly_layout.R'}
...
```{r Punctuality-ARR-YEARLY-LAYOUT, results='asis', eval=params$punc == "Y", echo = FALSE, file='R/fig_punctuality_arr_yearly_layout.R'}
...
```{r Punctuality-ARR-MONHTLY-LAYOUT, results='asis', eval=params$punc == "Y", echo = FALSE, file='R/fig_punctuality_arr_monthly_layout.R'}
...
```{r annual-turn-time, results='asis', eval=params$apdf == "Y", echo = FALSE, file='R/fig_turn_time_yearly.R'}
...
```{r monthly-turn-time, results='asis', eval=params$apdf == "Y", echo = FALSE, file='R/fig_turn_time_monthly.R'}
