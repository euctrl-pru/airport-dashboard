...
output: 
  flexdashboard::flex_dashboard:
    orientation : rows
    logo        : 'https://ansperformance.eu/images/EUROCONTROL-logo-standard-rgb.png'
    favicon     : 'https://ansperformance.eu/favicon.png'
    lib_dir     : 'docs/libs'
    self_contained: FALSE
    includes: 
      in_header: media/ga_script.html
---
...
RWY_CONFIG$ITEM[1] <- "Configurations in 2023"
...
if (nrow(params$tfcvar) < 1) {
  ...
  fig <- subplot(fig1, fig2, nrows = 2, shareX = TRUE) %>%
    ...
    add_download_button(tfcvar, "TFC_VAR")
...
```{r annual-traffic, code=readLines('R/fig_annual_traffic.R')}

```

### Monthly Traffic (Source: Network Manager)

```{r monthly-traffic, code=readLines('R/fig_monthly_traffic.R')}
...
```{r market-segment, code=readLines('R/fig_market_segment.R')}
...
```{r Avg-weekday-hourly-throughput, code=readLines('R/fig_avg_weekday_hourly_throughput.R')}
...
```{r atfm-pa, code=readLines('R/fig_annual_arr_atfm_delay.R')}

```

### Monthly Arrival ATFM Delay (Source: Network Manager)

```{r atfm-pm, code=readLines('R/fig_monthly_arr_atfm_delay.R')}
...
if (nrow(params$atfm) > 0) {
  ...
  p <- tmp %>%
    ...
    add_download_button(tmp %>% 
      select(FLT_DATE, ARR_ATFM_DLY = TOT_ARR_ATFM), 
      "ARR_ATFM_DLY_DD")
...
if (nrow(params$atfm) > 0) {
  ...
  share_atfm %>%
    ...
    add_download_button(share_atfm %>% select(REG_REASON, DLY_SHARE), "SHARE_ATFM_DLY_YY")
}
...
SLOT_YY_PLOT1 %>%
  ...
  add_download_button(SLOT_YY_PLOT1, "SLOT_ADH_YY")
...
#        modeBarButtonsToRemove = config_bar_remove_buttons) %>% 
#    add_download_button(SLOT_YY_PLOT1)
...
SLOT_MM_PLOT1 %>%
  ...
  add_download_button(SLOT_MM_PLOT1 %>% select(YEAR, MONTH = MONTH_NUM, PCT_DEP_REG, PCT_DEP_OUT), "SLOT_ADH_MM")
...
```{r ANNUAL-ATFM-SLOT2, code=readLines('R/fig_annual_atfm_slot.R')}

```

### Monthly ATFM Slot Adherence (Source: Network Manager)

```{r MONTHLY-ATFM-SLOT2, code=readLines('R/fig_monthly_atfm_slot.R')}
...
```{r Avg-time-lvl, results='asis', eval=nrow(params$cdo_cco)>0, echo = FALSE, code=readLines('R/fig_avg_time_lvl.R')}
...
```{r Med-CDO-CCO-alt, results='asis', eval=nrow(params$cdo_cco)>0, echo = FALSE, code=readLines('R/fig_med_cdo_cco_alt.R')}
...
```{r Share-unimpeded, results='asis', eval=nrow(params$cdo_cco)>0, echo = FALSE, code=readLines('R/fig_share_unimpeded_cdo_cco.R')}
...
cat("### Delta CO~2~ emissions due to level segments (Source: AIU analysis)")

```


```{r vfe-emissions, results='asis', eval=nrow(params$cdo_cco)>0, echo = FALSE, code=readLines('R/fig_vfe_emissions.R')}
...
#   config( displaylogo = FALSE,
#           modeBarButtonsToRemove = config_bar_remove_buttons) %>% 
#    add_download_button(MED_CDO_CCO_ALT_AVG_TIME_LVL_PLOT)
...
```{r ASMA-YEARLY-LAYOUT, results='asis', eval=params$apdf == "Y", echo = FALSE, code=readLines('R/fig_asma_yearly.R')}
...
```{r ASMA-MONTHLY-LAYOUT, results='asis', eval=params$apdf == "Y", echo = FALSE, code=readLines('R/fig_asma_monthly.R')}
...
cat("### Annual ASMA Time per Runway (Source: APDF)")

```


```{r ASMA-YEARLY-RUNWAY-LAYOUT, results='asis', eval=params$apdf == "Y", echo = FALSE, code=readLines('R/fig_asma_rwy_yearly.R')}

```

  
```{r ASMA-time-title4, results='asis', eval=params$apdf == "Y", echo = FALSE}

cat("### Monthly ASMA Time per Runway (Source: APDF)")

```


```{r ASMA-MONTHLY-RUNWAY-LAYOUT, results='asis', eval=params$apdf == "Y", echo = FALSE, code=readLines('R/fig_asma_rwy_monthly.R')}
...
```{r TXOT-YEARLY-LAYOUT, results='asis', eval=params$apdf == "Y", echo = FALSE, code=readLines('R/fig_taxi_out_yearly.R')}
...
```{r TAXI-OUT-MONTHLY-LAYOUT, results='asis', eval=params$apdf == "Y", echo = FALSE, code=readLines('R/fig_taxi_out_monthly.R')}
...
```{r Taxi-out-time-title3, results='asis', eval=params$apdf == "Y", echo = FALSE}

cat("### Annual Taxi-Out Time per Runway (Source: APDF)")

```


```{r TXOT-YEARLY-RUNWAY-LAYOUT, results='asis', eval=params$apdf == "Y", echo = FALSE, code=readLines('R/fig_taxi_out_rwy_yearly.R')}

```


```{r Taxi-out-time-title4, results='asis', eval=params$apdf == "Y", echo = FALSE}

cat("### Monthly Taxi-Out Time per Runway (Source: APDF)")

```


```{r TAXI-OUT-MONTHLY-RUNWAY-LAYOUT, results='asis', eval=params$apdf == "Y", echo = FALSE, code=readLines('R/fig_taxi_out_rwy_monthly.R')}
...
```{r TXIN-YEARLY-LAYOUT, results='asis', eval=params$apdf == "Y", echo = FALSE, code=readLines('R/fig_taxi_in_yearly.R')}
...
```{r TAXI-IN-MONTHLY-LAYOUT, results='asis', eval=params$apdf == "Y", echo = FALSE, code=readLines('R/fig_taxi_in_monthly.R')}
...
```{r Taxi-in-time-title3, results='asis', eval=params$apdf == "Y", echo = FALSE}

cat("### Annual Taxi-In Time per runway (Source: APDF)")

```


```{r TXIN-YEARLY-RUNWAY-LAYOUT, results='asis', eval=params$apdf == "Y", echo = FALSE, code=readLines('R/fig_taxi_in_rwy_yearly.R')}

```


```{r Taxi-in-time-title4, results='asis', eval=params$apdf == "Y", echo = FALSE}

cat("### Monthly Taxi-In Time per runway (Source: APDF)")

```



```{r TAXI-IN-MONTHLY-RUNWAY-LAYOUT, results='asis', eval=params$apdf == "Y", echo = FALSE, code=readLines('R/fig_taxi_in_rwy_monthly.R')}
...
```{r pre-dep-dly-pa, results='asis', eval=params$apdf == "Y", echo = FALSE, code=readLines('R/fig_pre_departure_delay_yearly.R')}
...
```{r pre-dep-dly-month, results='asis', eval=params$apdf == "Y", echo = FALSE, code=readLines('R/fig_pre_departure_delay_monthly.R')}
...
```{r Monthly-pre-dep-delay, results='asis', eval=params$apdf == "Y", echo = FALSE, eval=FALSE}
...
predepdly_py %>%
  ...
  add_download_button(predepdly_py %>% select(AIRPORT, YEAR, AVG_DLY_DUR = DLY_89_PER_FL_YY), "ATC_PRE_DEP_DLY_YY")
...
predepdly_pm %>% 
  # mutate(YEAR = factor(YEAR, levels = unique(predepdly_pm$YEAR))) %>%
  arrange(YEAR, MONTH_NUM) %>% 
  plot_ly(
    x          = ~MONTH_NUM,
    y          = ~DLY_89_PER_FL_MM,
  ...
  add_download_button(predepdly_pm %>% mutate(AIRPORT = icao) %>% select(AIRPORT, YEAR, MONTH = MONTH_NUM, AVG_DLY_DUR = DLY_89_PER_FL_MM),"ATC_PRE_DEP_DLY_MM")
...
```{r Punctuality-DEP-YEARLY-LAYOUT, results='asis', eval=params$punc == "Y", echo = FALSE, code=readLines('R/fig_punctuality_dep_yearly_layout.R')}
...
```{r Punctuality-DEP-MONHTLY-LAYOUT, results='asis', eval=params$punc == "Y", echo = FALSE, code=readLines('R/fig_punctuality_dep_monthly_layout.R')}
...
```{r Punctuality-ARR-YEARLY-LAYOUT, results='asis', eval=params$punc == "Y", echo = FALSE, code=readLines('R/fig_punctuality_arr_yearly_layout.R')}
...
```{r Punctuality-ARR-MONHTLY-LAYOUT, results='asis', eval=params$punc == "Y", echo = FALSE, code=readLines('R/fig_punctuality_arr_monthly_layout.R')}
...
```{r annual-turn-time, results='asis', eval=params$apdf == "Y", echo = FALSE, code=readLines('R/fig_turn_time_yearly.R')}
...
```{r monthly-turn-time, results='asis', eval=params$apdf == "Y", echo = FALSE, code=readLines('R/fig_turn_time_monthly.R')}
...
plot_ly(TURN_DDI, 
  ...
  config( displaylogo = FALSE,
          modeBarButtonsToRemove = config_bar_remove_buttons) %>% 
  add_download_button(TURN_DDI %>% select(YEAR, MONTH = MONTH_NUM, DDI_G = AVG_ADTT, TDI = AVG_ERTT), "TURNAROUND_DDI_TDI_MM")
...
plot_ly(TURN_OVER, 
  ...
  config( displaylogo = FALSE,
          modeBarButtonsToRemove = config_bar_remove_buttons) %>% 
  add_download_button(TURN_OVER %>% select(YEAR, MONTH = MONTH_NUM, GTO_SHARE = AVG_OVER), "TURNAROUND_GTO_MM")
```
...
![](https://ansperformance.eu/images/EUROCONTROL-logo-standard-rgb.png){width=25%}
