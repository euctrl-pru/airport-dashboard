...
```{r ASMA-RWY-YEARLY-LAYOUT, results='asis', eval=params$apdf == "Y", echo = FALSE, file = 'R/fig_asma_rwy_yearly.R'}
...
```{r ASMA-RWY-MONTHLY-LAYOUT, results='asis', eval=params$apdf == "Y", echo = FALSE, file = 'R/fig_asma_rwy_monthly.R'}
...
```{r TAXI-OUT-RWY-YEARLY-LAYOUT, results='asis', eval=params$txotrwy_yy  == "Y", echo = FALSE, file = 'R/fig_taxi_out_rwy_yearly.R'}
...
```{r TAXI-OUT-RWY-MONHTLY-LAYOUT, results='asis', eval=params$txotrwy_mm == "Y", echo = FALSE, file = 'R/fig_taxi_out_rwy_monhtly.R'}
...
```{r TAXI-IN-RWY-YEARLY-LAYOUT, results='asis', eval=params$apdf == "Y", echo = FALSE, file = 'R/fig_taxi_in_rwy_yearly.R'}
...
```{r TAXI-IN-RWY-MONTHLY-LAYOUT, results='asis', eval=params$apdf == "Y", echo = FALSE, file = 'R/fig_taxi_in_rwy_monthly.R'}
