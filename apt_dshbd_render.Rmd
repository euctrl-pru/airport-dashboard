...
```{r Avg-weekday-hourly-throughput}
thru <- params$thru %>%
  filter(
    TIME >= hm("05:55"),
    TIME <= hm("23:05")
...
plot_ly(MED_CDO_CCO_ALT_PLOT, 
        ...
        hovertemplate = "%{y:.0f}",
        type = 'scatter',
        mode = ifelse(nrow(filter(MED_CDO_CCO_ALT_PLOT, YEAR==max_year))>1, 'lines', 'lines+markers'),
        name = 'Descent (Fuel CDO)',
        transforms = list(list(type      = 'filter',
                               target    = "customdata",
                               operation = '=',
...
plot_ly(SHARE_CDO_CCO_FLIGHTS_PLOT, 
        ...
        hovertemplate = "%{y:.1f}%",
        type = 'scatter',
        mode = ifelse(nrow(filter(SHARE_CDO_CCO_FLIGHTS_PLOT, YEAR==max_year))>1, 'lines', 'lines+markers'), 
        name = 'Descent (Fuel CDO)',
        transforms = list(list(type      = 'filter',
                               target    = "customdata",
                               operation = '=',
